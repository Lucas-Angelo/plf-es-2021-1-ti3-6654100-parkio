...
:-:|:-:|:-:|:-:
1 | O porteiro cadastra os veículos no sistema.| Alta | Média
...
3 | O porteiro ao informar que o o veículo deixou o estacionamento deve definir o Status do veículo visitante para 'Saiu' e marcar uma avaliação de como foi comportamento do condutor. | Alta | Média
...
13 | O sistema deverá possuir um relatório delimitado por um filtro de período de tempo, porteiro e/ou placa do carro, determinado pelo usuário administrador. | Baixa | Alta
