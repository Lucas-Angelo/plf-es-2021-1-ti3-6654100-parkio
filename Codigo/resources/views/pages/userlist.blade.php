...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 p-0 m-0">
            <button id="btn-NovoUsuario" class="btn btn-secondary" data-bs-toggle="modal"
                data-bs-target="#modalNovoUsuario"><i class="fas fa-plus"></i>&nbsp;Novo Usuário</button>
        </div>
    </div>
    <div class="row">
        <div class="col-12 p-0 m-0">
                ...
                <div class="modal-body justify-content-center">
                    <form onSubmit="handleEntranceFormSubmit(event)" id="cadastro" class="justify-content-center">
                        <div class="mb-3">
                            ...
                            <input for="input-name" type="text" class="form-control" id="input-name" minlength="1"
                                maxlength="255" required>
                        </div>
                        <div class="mb-3">
                            <label for="input-user" class="form-label">Usuário <span class="required">*</span></label>
                            <input for="input-user" type="text" class="form-control" id="input-user" minlength="1"
                        ...
                        <button id="close-modal" type="button" class="btn btn-secondary d-none"
                            data-bs-dismiss="modal">Close</button>
                        <button id="btn-cadastrar" type="submit"
                            class="btn btn-primary w-100 mt-2 mb-3">Cadastrar</button>
                    </form>
                </div>
            </div>
        </div>
